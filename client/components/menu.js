...
const MenuComponent = {
  ...
  template: `
    ...
    <a class="nav-link dropdown-toggle"  data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Kategorier</a>
    <div class="dropdown-menu" >
    <router-link class="dropdown-menu" to="/products">All</router-link>
